...
class LoginPharmacien(ctk.CTk):
    ...
    def ajouter_logo(self, taille=(110, 110)):
        try:
            img = ctk.CTkImage(light_image=Image.open("mokkt.jpg"), dark_image=Image.open("mokkt.jpg"), size=taille)
            ...
            ctk.CTkLabel(logo_frame, text="💊", font=("Segoe UI", 38), text_color="white").place(relx=0.5, rely=0.5, anchor="center")
...
class DashboardPharmacien(ctk.CTk):
    ...
    def _construire_interface(self):
        ...
        try:
            img = ctk.CTkImage(light_image=Image.open("mokkt.jpg"), dark_image=Image.open("mokkt.jpg"), size=(120, 120))
            ...
            ctk.CTkLabel(logo_f, text="💊", font=("Segoe UI", 32), text_color="white").place(relx=0.5, rely=0.5, anchor="center")
    ...
    def _entete_section(self, titre, sous_titre=""):
        ...
        if sous_titre:
            ctk.CTkLabel(f, text=sous_titre, font=FONT_PETIT, text_color=COULEURS["texte_gris"]).pack(anchor="w", pady=(2, 0))
    ...
    def afficher_profil(self):
        ...
        ctk.CTkLabel(header, text=nom, font=("Segoe UI", 20, "bold"), text_color="white").pack(anchor="w", padx=30, pady=(18, 0))
        ctk.CTkLabel(header, text=phar, font=("Segoe UI", 12), text_color=COULEURS["teal_doux"]).pack(anchor="w", padx=30)
    ...
    def afficher_controle_ordo(self):
        ...
        self.resultat_analyse.insert("0.0", "Système prêt. Entrez les médicaments pour vérifier les risques avant délivrance.")
    ...
    def lancer_analyse(self):
        ...
        if "aspirine" in meds:
            ...
            self.resultat_analyse.insert("end", "📢  Conseil Darija : « Balek a aami! Had el dwa m3a hada ydirlek nezif fel karch. »\n")
            self.resultat_analyse.insert("end", "➡  ACTION REQUISE : Contacter le médecin prescripteur pour modification.")
        else:
